...
# set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports caa]
# set_property -dict {PACKAGE_PIN R10 IOSTANDARD LVCMOS33} [get_ports cab]
# set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33} [get_ports cac]
# set_property -dict {PACKAGE_PIN K13 IOSTANDARD LVCMOS33} [get_ports cad]
# set_property -dict {PACKAGE_PIN P15 IOSTANDARD LVCMOS33} [get_ports cae]
# set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports caf]
# set_property -dict {PACKAGE_PIN L18 IOSTANDARD LVCMOS33} [get_ports cag]
...
# set_property -dict {PACKAGE_PIN E16 IOSTANDARD LVCMOS33} [get_ports jblock]
